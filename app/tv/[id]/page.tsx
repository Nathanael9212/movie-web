...
export default async function TVShowDetailPage({
  ...
  const backdropUrl = TMDB_IMAGE.backdrop(show.backdrop_path, "original");
                ...
                <div className="relative w-24 h-24">
                  <svg className="w-24 h-24 transform -rotate-90">
                    ...
                    <circle
                      ...
                      strokeWidth="8"
                      fill="none"
                      strokeDasharray={`${(show.vote_average / 10) * 264} 264`}
                      strokeLinecap="round"
                    />
                  </svg>
                  <div className="absolute inset-0 flex flex-col items-center justify-center">
                    ...
                    <span className="text-xs text-gray-400">{show.vote_count} votes</span>
                  </div>
                </div>
